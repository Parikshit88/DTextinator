...
export default function TextForm(props) {
  ...
  return (
    ...
    <h1 style={{color: props.mode==='dark'?'white':'#343a40'}}>{props.heading}</h1>
        ...
        <button className="btn btn-secondary mx-2 my-1" style = {{backgroundColor: props.mode==='dark'?'white':'#343a40',color: props.mode==='dark'?'#343a40':'white', cursor: 'pointer'}} onClick={handleClearClick}>Clear Text</button>
        <button className="btn btn-secondary mx-2 my-1" style = {{backgroundColor: props.mode==='dark'?'white':'#343a40',color: props.mode==='dark'?'#343a40':'white', cursor: 'pointer'}} onClick={handleRESClick}>Remove Extra Spaces</button>
        <button className="btn btn-secondary mx-2 my-1" style = {{backgroundColor: props.mode==='dark'?'white':'#343a40',color: props.mode==='dark'?'#343a40':'white', cursor: 'pointer'}} onClick={handleRemoveSCClick}>Remove Special Characters</button>
